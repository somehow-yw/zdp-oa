...
use App\Repositories\DailyNews\Contracts\DailyNewsRiseGoodsRepository as RepositoriesContract;

use App\Models\DpRiseRecord;
use App\Models\DpDailyNewsGoodsInfo;

use App\Exceptions\AppException;
use App\Exceptions\DailyNews\DailyNewsExceptionCode;

class DailyNewsRiseGoodsRepository implements RepositoriesContract
{
    /**
     * 取得商品信息
     *
     * @see \App\Repositories\DailyNews\Contracts\DailyNewsRiseGoodsRepository::getGoodsList()
     *
    ...
    public function getGoodsList($areaId, $size)
    {
        ...
        $goodsInfoObjs = DpRiseRecord::where('divide_id', $areaId)
     ...
     * 商品屏蔽操作
     *
     * @see \App\Repositories\DailyNews\Contracts\DailyNewsRiseGoodsRepository::shieldGoods()
     *
     * @param int $id           操作ID
    ...
    {
        $goodsInfoObj = DpRiseRecord::where('id', $id)
